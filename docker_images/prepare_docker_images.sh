...
#files copies
echo "Files copies..."
cp $FOLDER_NAME$PRODUCER_JAR_NAME $PRODUCER_IMAGE_FOLDER_PATH$PRODUCER_JAR_NAME
cp $FOLDER_NAME$CONSUMER_JAR_NAME $CONSUMER_IMAGE_FOLDER_PATH$CONSUMER_JAR_NAME
#cp $DOCKERFILE producer/$DOCKERFILE
#cp $DOCKERFILE consumer/$DOCKERFILE
echo "Files copied!"
